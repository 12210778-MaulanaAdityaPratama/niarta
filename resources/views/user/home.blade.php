<!DOCTYPE html>
<!--
This is a starter user.template page. Use this page to start your new project from
            ...
            @foreach ($perizinan->groupBy('jenis_usaha') as $jenisUsaha => $groupedPerizinan)
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-info">
                        ...
                        <a href="{{ route('user.perizinan', ['jenis_usaha' => $jenisUsaha]) }}" class="small-box-footer" >Lihat Data <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            @endforeach
        </div>
